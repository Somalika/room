<div class="row">
	...
	<div class="col-md-12 col-sm-12 clearfix ">
        ...
        <!-- Language Selector -->			
           <li class="dropdown language-selector">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-close-others="true">
                        	<i class="entypo-user"></i> <?php echo $this->session->userdata("FULL_NAME_KH");;?>
                    </a>
		...
		<ul class="list-inline links-list pull-right">
            <li>
                <a href="<?php echo base_url();?>index.php?fleet">
                    <i class="fa fa-truck right"></i> Fleets
                </a>
            </li>
        
        	<li class="dropdown language-selector">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-close-others="true">
                        <i class="entypo-bell"></i><span><?php echo get_phrase('notification');?></span>
                    </a>
           ...
           <li class="dropdown language-selector">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-close-others="true">
                        <i class="entypo-globe"></i><span><?php echo get_phrase('language');?></span>
                    </a>
