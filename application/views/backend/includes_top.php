...
<script src="<?php echo base_url();?>assets/js/jquery-ui/js/jquery-1.9.1.js"></script>
<script src="<?php echo base_url();?>assets/js/jquery-ui/jquery-ui.js"></script>

 
<script src="<?php echo base_url();?>assets/js/customize.js" type="text/javascript"></script> 
