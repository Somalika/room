			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open('admin/transport/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                            ...
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('number_of_vehicle');?></label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('route_fare');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="" name="route_fare"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('two_ways');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="" name="two_way"/>  USD
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('one_way');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="" name="one_way"/> USD
                                </div>
                            </div>
                        </div>
                        <div class="form-actions"><center>
                            <button type="submit" class="btn btn-gray"><?php echo get_phrase('add_transport');?></button></center>
                        </div>
                    </form>                
                </div>                
			</div>
